...
### In [osint](https://github.com/greeny-blue/data-science-notes/tree/main/osint) you'll find odd bits of OSINT work I've done.
  ...
  - [A simple projection of Russian army size](https://github.com/greeny-blue/data-science-notes/blob/main/osint/russian_army_size_projections/Russian-army-size-change-projections.md) based on reported casualty rates since December 2025 and a range of assumed recruitment levels. This was prompted by a recent claim that recruitment may have fallen to ~800 per day, and explores what that might imply for force size over time.
